...
module.exports = "<app-pagination></app-pagination>"
...
/* harmony import */ var _pagination_pagination_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pagination/pagination.component */ "./src/app/pagination/pagination.component.ts");
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getData = function (i) {
...
module.exports = "<h1 >Data Pagination Demo</h1>\n\n<ul>\n  <li *ngFor=\"let post of post\">{{post.officeName}}</li>\n</ul>\n\n<ul class=\"pagination\">\n  \n  <li *ngFor=\"let post of pageN; index as i\" (click)=\"getDataToShow(i+1)\"><a      routerLink=\"#\">{{i+1}}</a>\n  </li>\n  \n  \n</ul>"
...
var PaginationComponent = /** @class */ (function () {
    ...
    PaginationComponent.prototype.ngOnInit = function () {
        ...
        this.data.getAllData()
            .subscribe(function (data) {
            _this.pageN = new Array(data);
        });
    };
    PaginationComponent.prototype.getDataToShow = function (i) {
        var _this = this;
        this.data.getData(i)
            .subscribe(function (data) {
            _this.post = data;
...
module.exports = __webpack_require__(/*! E:\paginationDemo\src\main.ts */"./src/main.ts");
